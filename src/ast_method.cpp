...
j4a::string Method::get_c_jni_id_name()
{
    std::ostringstream os;
    os << "method_" << get_name();
    return os;
...
j4a::string Method::get_c_jni_method_name()
{
    return get_name();
}

j4a::string Method::get_c_call_api()
{
    if (is_static()) {
...
j4a::string Method::get_c_call_object_id()
{
...
j4a::string Method::get_c_call_method_id()
{
    std::ostringstream os;
