...
j4a::string PropertyGetter::get_c_call_api()
{
    if (is_static()) {
...
j4a::string PropertyGetter::get_c_call_method_id()
{
...
j4a::string PropertySetter::get_c_call_api()
{
    if (is_static()) {
...
j4a::string PropertySetter::get_c_call_method_id()
{
    std::ostringstream os;
    os << get_this_class()->get_c_jni_class_instance() << "." << get_field()->get_c_jni_id_name();
    return os;
